          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-lg-8">
              <div className="slide">
                ...
                <div className="result_box">10</div>
              </div>
            </div>
          </div>

          <table
            className="table table-borderless table-hover table-responsive-sm"
          ...
          >
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <button className="btn-success">Add Star</button>
                </td>
                <td>⭐</td>
                <td>⭐</td>
                <td>⭐</td>
                ...
                <td>⚫</td>
                <td>
                  <button className="btn-success">Issue Certificate</button>
                </td>
              </tr>
              <tr>
                <th scope="row" className="font-weight-bold">
